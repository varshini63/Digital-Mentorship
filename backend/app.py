...
GEMINI_API_KEY_story = 'AIzaSyB5QsOHgj_QwXButK6esbXpOk4i8RNoEQY'  # Replace with your actual API key
GEMINI_API_ENDPOINT_story = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent'

@story_generator_bp.route('/api/generate-story', methods=['POST'])
def generate_story():
    try:
        ...
        prompt = f"Generate a story to understand the topic '{topic}' in {language} for a student in {standard} standard covering all the important points about {topic} that creates an intrest to learn that too in simple understandable language."
        ...
        api_url = f"{GEMINI_API_ENDPOINT_story}?key={GEMINI_API_KEY_story}"
